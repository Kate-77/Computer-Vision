...
%% localiser les minuties et afficher toutes ces minuties
text51='Minutia';
h=uicontrol(FigWin,...
   'Style','pushbutton',...
...
% Procédé de suppression de minuties parasites
...
% Enregistrer le fichier de modèle, y compris la position, la direction et les informations sur la crête
...
% Appeler le chargeur de fichiers du modèle et faire la correspondance (matching)
